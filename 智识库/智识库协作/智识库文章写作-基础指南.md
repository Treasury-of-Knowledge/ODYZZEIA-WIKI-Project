...
> 如果你希望你的教程只能被社区内部成员看到，需要给页面添加 **discord** 标签，不添加的话就是公开开放阅读
![discord-tag.png](/all_upload_files_should_in_here/tutorials/wiki_writing_tutorials/article_writing_guide_basic/discord-tag.png)
{.is-warning}
...
> 此外，还请小伙伴们注意！
如果你的文章是转载他人的教程，那么**需要得到教程原作者的授权**同意才可以搬运哦！并且还**需要在教程开头处放置 “与原作者取得授权” 的相关证明**以避免争议。
{.is-warning}
