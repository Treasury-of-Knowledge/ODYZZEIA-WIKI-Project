...
## 引言
欢迎来到***类脑智识库 · ΓΝΩΣΗ WIKI***，本智识库是类脑ΟΔΥΣΣΕΙΑ 【中文 SillyTavern(傻子酒馆) 社区】 的周边项目，目前，WIKI**主要供类脑ΟΔΥΣΣΕΙΑ社区内部成员使用**，亦有社区成员开放的知识共享文档供大众阅读。
...
> **智识库面向所有热衷于 AIRP 社区的、善意的创作者接纳投稿**
{.is-success}

> **由于智识库流量过大，目前仅登录后可实时看到内容变更，游客需等待缓存过期(约2小时)后才可获得页面最新内容**
{.is-info}
...
如果你在使用过程中有任何反馈或建议，请前往 [智识库反馈帖](https://discord.com/channels/1134557553011998840/1486732626457919609) 内反馈。
**使用Discord登录智识库可能导致图片无法显示，问题正在修复中，请耐心等待。**
