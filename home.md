...
---
 ...
 <blockquote class="is-danger">
  ...
  <b>自“旅程类脑分裂事件”以来，智识库始终坚持中立立场，从未对类脑或旅程的任何一方给予偏袒，而是选择信任并接纳 AIRP 社区的每一位成员。也正因如此，在过去的半年里，旅程的管理员也持续在智识库管理团队中担任要职。

甚至在旅程管理组计划自行筹建旅程 Wiki、并询问是否可以搬运智识库相关内容时，我们的态度依旧是明确且开放的：只要遵循智识库协议与社区普遍认可的标准（知识共享署名–非商业性–相同方式共享许可，并标注转载出处），即可进行搬运与引用。

然而，近期旅程内部管理层曝光的聊天记录显示，部分旅程管理组成员在讨论中流露出有意破坏、贬损社区劳动成果的倾向。对此，智识库管理团队深感遗憾与失望，并对旅程服务器予以严正谴责。
    
我们始终相信，一个良性发展的社区应建立在诚信、友善与公正之上，而非破坏、滥权与抹黑。
</b>
	</blockquote> 
